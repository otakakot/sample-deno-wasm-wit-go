...
function add(arg0, arg1) {
  const ret = exports1.add(toInt32(arg0), toInt32(arg1));
  return ret;
}
...
const $init = (() => {
  let gen = (function* init () {
    ...
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABCAFgBH9/f38AAhUCAAEwAAAACCRpbXBvcnRzAXABAQEJBwEAQQALAQAALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjIxOS4xABwEbmFtZQAVFHdpdC1jb21wb25lbnQ6Zml4dXBz');
